...
?>
<h1 class="kt-page-title">打刻修正申請</h1>

<div class="kt-card">
    <form action="/kintai/clock-edit" method="POST">
        ...
        <div class="kt-card-body">
            ...
            <div class="kt-form-row">
                ...
                <div class="kt-form-control">
                    <select class="kt-select" name="edit_type" style="min-width:260px;">
